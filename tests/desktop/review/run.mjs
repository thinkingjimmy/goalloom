...
for (const name of process.argv.slice(2).length ? process.argv.slice(2) : ['renderer', 'lifecycle', 'virtual', 'wire', 'large-workspace', 'package-report']) {
  if (['scaling', 'large-workspace'].includes(name)) {

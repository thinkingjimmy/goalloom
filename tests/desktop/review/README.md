...
- `renderer.mjs`: current-source Chromium with delayed IPC/imports; input/save revisions, late previews, pagination, search recovery and nested lazy-dialog visibility.

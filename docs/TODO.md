...
**当前进度（2026-09-23）：** M0 已获负责人确认（多父 DAG、固定三日历月、macOS 14+ Apple Silicon / Windows 11 x64、中文、本人内测）；M1 本机持久化闭环已实现，M2 五列、生命周期与效果撤销已实现并正在验证真实窗口。跨平台安装和人工实机验收仍单独追踪，实际命令、版本和测试结果随开发提交记录。

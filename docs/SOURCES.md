...
文档v0.3.1 · 2026-09-21。产品交互与数据口径由本项目定义，已批准的方向见DECISIONS；下面的外部来源用于核对技术事实，不代表来源认可本产品或保证实现质量。
...
用途：首次创建私人仓库、从本地 source 推送及 remote 参数。创建说明保留为历史步骤；现有私人仓库及初始提交06e70d5已读回确认，不应重新创建。

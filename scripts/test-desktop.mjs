...
try {
  ...
  assert.deepEqual((await page.evaluate(() => Object.keys(window.goalloom))).sort(), ['data', 'execute', 'exportWorkspace', 'getActivity', 'getBatches', 'getHistory', 'getItem', 'getReceipt', 'getRuntime', 'getSnapshot', 'listItems', 'onChanged'])

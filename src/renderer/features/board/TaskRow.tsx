 ...
 * [OUTPUT]: Memoized accessible task row with saved-text links, lazy preview cards, flow dot and keyboard/pointer drag controls; a lit row carries `data-lit` and `--row-tint`.
